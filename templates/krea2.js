...
CONFIG.displayResult = async function(entry, realSeed, tTotal, promptId){
  ...
  variantCounter++;
  currentBatchIndex++;
  // Common finalize skipped here because we already advanced; return true.
  return true;
};
...
function onFsEnter(){
  requestAnimationFrame(() => { void $("outputImg").offsetWidth; const wrap = $("imgWrap"); if(wrap){ wrap.style.cssText = "position:fixed!important;top:0!important;left:0!important;width:100vw!important;height:100vh!important;max-height:none!important;margin:0!important;padding:0!important;background:#000;border-radius:0;z-index:2147483647;display:flex;align-items:center;justify-content:center;"; const img=$("outputImg"); if(img){ img.style.cssText="display:block!important;width:100vw!important;height:100vh!important;max-width:100vw!important;max-height:100vh!important;object-fit:contain!important;transform:none!important;transform-origin:center center!important;"; } } });
}
