...
$("btnSendRefLtxv").addEventListener("click", async () => {
  ...
  // data:URL: la imagen es local del navegador. La subimos a ComfyUI en
  // output/krea2/ con un nombre temporal y le pasamos ese filename a LTXV,
  // que la encontrará en el panel "Imágenes Krea2 recientes".
  if(!src.startsWith("data:")){
    log("⚠️ Origen de imagen no soportado: "+src.slice(0,40), "l-err");
    return;
  }
  log("⏳ Subiendo imagen de referencia a ComfyUI para enviarla a LTXV...", "l-info");
  try {
