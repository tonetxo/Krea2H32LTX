...
$("segAttnBlockSparse")?.addEventListener("click", () => { setAttentionOptimizerUI("block-sparse"); saveAttentionOptimizer({mode:"block-sparse"}); scheduleSaveH3Settings(); });
...
// Solo mostramos el resultado y devolvemos false para que common.js avance el batch.
