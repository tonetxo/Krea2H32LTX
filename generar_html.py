...
<div class="wrap">
  ...
  <div class="grid">
    <div class="controls-col">
      <div class="panel"><h2>Servidor</h2><div class="server-row"><input type="text" id="serverUrl" value="" placeholder="http://127.0.0.1:7821" spellcheck="false"><button id="btnTest" class="ghost">Probar</button></div><div class="statusbar"><span class="dot" id="connDot"></span><span id="connText">sin comprobar</span></div></div>
...
function startTimer(promptId){
  ...
  t.iv = setInterval(() => {
    if(!timers[promptId]) return; // cerrado en otra tick
...
// el host de window.location es esa IP LAN. El backend en :7821 también debe estar
...
// Si el input sigue vacío o apunta a loopback, lo reescribimos a http://<hostname>:7821.
