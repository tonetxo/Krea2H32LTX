...
function buildGraph(){
  ...
  g[N.LORA1].inputs.lora_name = loras[0].lora; g[N.LORA1].inputs.strength_model = loras[0].strength;
  g[N.LORA2].inputs.lora_name = loras[1].lora; g[N.LORA2].inputs.strength_model = loras[1].strength;
  g[N.LORA3].inputs.lora_name = loras[2].lora; g[N.LORA3].inputs.strength_model = loras[2].strength;
